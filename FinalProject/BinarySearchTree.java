...
{  
    ...
    */
   public void add(Comparable<Student> obj) 
   {  
    ...
    * null if not
    */
   public Comparable<Student> find(Comparable<Student> obj)
   {
      Node current = root;
      while (current != null)
      {
         int d = current.data.compareTo((Student) obj);         
         if (d == 0)
         {             
             return current.data;
         }
    ...
    */
   public void remove(Comparable<Student> obj)
   {
      ...
      {
         int d = toBeRemoved.data.compareTo((Student) obj);
         if (d == 0)
             found = true;
         else 
         {
   ...
   {  
      /** the data object in the node */
       public Comparable<Student> data;
      ...
      {  
         int comp = newNode.data.compareTo((Student) data);
         if (comp < 0)
         {  
            if (left == null) 
                left = newNode;
